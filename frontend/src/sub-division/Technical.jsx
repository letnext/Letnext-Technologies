          ...
          {cardsData.map((card) => (
            ...
            >
              ...
              <div className="card-image-wrapper">
                <img src={card.image} alt="IT service and Digital marketing" className="card-image" loading="lazy" decoding="async" />
