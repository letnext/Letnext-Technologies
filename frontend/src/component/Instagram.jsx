          ...
          <div className="instagram-header-content">
            <div className="instagram-avatar">
              <div className="instagram-story-ring">
                <img                   src="https://ui-avatars.com/api/?name=LetNext+Tech&background=E1306C&color=fff&bold=true"
          ...
          <div className="instagram-stories-bar">
            <div className="story-item active" onClick={() => handleQuickAction("story")}>
              <div className="story-avatar">
                <img                   src="https://ui-avatars.com/api/?name=Services&background=667781&color=fff"
                  alt="Services"
                loading="lazy" decoding="async" />
              </div>
            ...
            <div className="story-item" onClick={() => handleQuickAction("story")}>
              <div className="story-avatar">
                <img                   src="https://ui-avatars.com/api/?name=Projects&background=FF6B6B&color=fff"
                  alt="Projects"
                loading="lazy" decoding="async" />
              </div>
            ...
            <div className="story-item" onClick={() => handleQuickAction("story")}>
              <div className="story-avatar">
                <img                   src="https://ui-avatars.com/api/?name=Team&background=4ECDC4&color=fff"
                  alt="Team"
                loading="lazy" decoding="async" />
              </div>
            ...
            <div className="story-item" onClick={() => handleQuickAction("story")}>
              <div className="story-avatar">
                <img                   src="https://ui-avatars.com/api/?name=News&background=FFD93D&color=333"
                  alt="News"
                loading="lazy" decoding="async" />
              </div>
        ...
        <div className="instagram-chat-body">
          ...
          <div className="instagram-message received">
            <div className="message-avatar">
              <img                 src="https://ui-avatars.com/api/?name=LT&background=E1306C&color=fff&bold=true"
                alt="LetNext"
              loading="lazy" decoding="async" />
            </div>
