        ...
        <div className="linkedin-chat-header">
          <div className="linkedin-header-content">
            <div className="linkedin-avatar">
              <img                 src="https://ui-avatars.com/api/?name=LetNext+Tech&background=0a66c2&color=fff&bold=true&size=128"
        ...
        <div className="linkedin-chat-body">
          ...
          <div className="linkedin-message received">
            <div className="message-avatar">
              <img                 src="https://ui-avatars.com/api/?name=LT&background=0a66c2&color=fff&bold=true"
                alt="LetNext"
              loading="lazy" decoding="async" />
            </div>
